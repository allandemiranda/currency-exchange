...
public class TransactionAssembler implements RepresentationModelAssembler<TransactionDto, EntityModel<TransactionDto>> {
  ...
  public @NonNull EntityModel<ClientTransactionDto> toModel(final @NonNull ClientTransactionDto clientTransactionDto, final @NotNull Long clientId, final @NotNull UUID accountId) {
  ...
  public CollectionModel<EntityModel<ClientTransactionDto>> toCollectionModel(final @NonNull Iterable<ClientTransactionDto> clientTransactionDtos, final @NotNull Long clientId,
