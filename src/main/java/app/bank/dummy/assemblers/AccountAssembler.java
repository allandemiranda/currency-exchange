...
public class AccountAssembler implements RepresentationModelAssembler<AccountDto, EntityModel<AccountDto>> {
  ...
  public @NonNull EntityModel<ClientAccountDto> toModel(final @NonNull ClientAccountDto clientAccountDto, final @NonNull Long clientId) {
  ...
  public CollectionModel<EntityModel<ClientAccountDto>> toCollectionModel(final @NonNull Iterable<ClientAccountDto> entities, final @NonNull Long clientId) {
