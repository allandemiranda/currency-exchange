 ...
 */
public record ClientTransactionDto(UUID id, LocalDateTime dataTime, double amount, double taxRate, double tmpBalance, TransactionType type, UUID account) implements Serializable {
